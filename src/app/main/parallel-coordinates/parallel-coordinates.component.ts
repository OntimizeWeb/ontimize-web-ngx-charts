...
export class ParallelCoordinatesComponent implements OnInit {
  ...
  getBasicId() {
    return 'Parallel Coordinates Chart (Basic Usage)';
  }
  ...
  getCustomId() {
    return 'Parallel Coordinates Chart (Custom Usage)';
  }
...
<o-chart type="parallelCoordinatesChart" flex="75" chart-height="350" entity="EDimensionData" [chart-parameters]="chartConf2"></o-chart>
`;
...
<o-chart #chart type="parallelCoordinatesChart" flex="75" chart-height="350"
[chart-parameters]="chartConf"></o-chart>
`;
